    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      ...
      >
        ...
        <p
          ...
          ref={anim3Ref}
        >
          A <span className="font-medium">passionate group of developers</span>{' '}
          based all around the globe. Working together to provide you with all
          the <span className="font-medium">Discord Bots, Websites</span> and{' '}
          <span className="font-medium">Services you know and love.</span>
        </p>
        <div
        ...
        >
          <FaChevronDown className="bounce" style={{ fontSize: '3rem' }} />
        </div>
      </section>
    </div>
  )
