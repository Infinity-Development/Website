...
const Header = () => {
    const menu = [
        ...
        { icon: <FaDiscord />, title: "Discord", href: "https://infinitybots.gg/discord", target: true, },
        {
            icon: <FaTwitter />,
            title: "Twitter",
    ...
    return (
        <nav className="w-full sm:w-10/12 flex justify-between items-center fixed top-0 py-7 z-50 max-w-screen-xl sm:max-w-screen-xl sm:w-10/12 sm:flex-col sm:h-auto sm:items-end sm:text-right sm:p-0 sm:bg-transparent right-2">
                    ...
                    >
                        ...
                        >
                            <div className="flex items-center justify-center p-1 rounded-md">
                                <div items-left style={{ marginRight: "10px" }}>{section.icon}</div>
            ...
            {/* Mobile Menu */}
            {showMobileMenu && (
              <div className="top-0 left-0 w-full bg-gray-800 z-50" style={{ marginBottom: "10px" }}>
